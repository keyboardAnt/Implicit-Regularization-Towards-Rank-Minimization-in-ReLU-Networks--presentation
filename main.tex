...
\begin{frame}
    \begin{columns}
        ...
        Assume towards~contradiction: GF converges to some 0-loss~network $N_{W(\infty),V(\infty)}$ s.t. $\rank(W(\infty))<2$.
            \begin{itemize}[<+->]
