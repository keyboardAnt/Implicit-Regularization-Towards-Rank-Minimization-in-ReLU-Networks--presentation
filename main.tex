...
\begin{frame}{More previous work...}{Implicit regularization in *nonlinear* networks w/ square~loss}
    ...
    \end{enumerate}
    There are also other works on the dynamics and implicit~bias of GD in wide~depth-$2$~ReLU~networks of \alert{input~dimension~$1$}. (\cite{williams2019gradient} and \cite{jin2020implicit}.)
    }
\end{frame}
