...
\begin{frame}{Proof ideas}
    ...
    \note{
        Now, to the main ideas in the proofs. We start with the first theorem. I~will briefly remind the statement.
        \begin{enumerate}
...
\begin{frame}
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            \begin{center}
                \includegraphics<1-4>[width=\textwidth]{figures/D_and_Ss_regions.png}%
                \includegraphics<5->[width=\textwidth]{figures/F_and_A_regions.png}%
            \end{center}
        \end{column}
    \end{columns}
