...
\begin{frame}
    ...
    \note{
        \begin{enumerate}
            ...
            There are many ways to define such closeness. For example, the ratio of the Frobenius and spectral~norms, or what is known as the ``essential/stable rank" (it is the exponential of the entropy of the normalized singular~values).\\
