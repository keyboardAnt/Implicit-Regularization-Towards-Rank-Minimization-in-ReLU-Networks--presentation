...
\begin{frame}{Previous work}{Implicit regularization in linear networks (w/ square~loss)}
    ...
    \begin{enumerate}
        ...
        \item Then, \cite{li2020towards} established theoretical and empirical evidence that the implicit~regularization in matrix~factorization is indeed a heuristic for rank~minimization.
