...
\begin{frame}
    ...
    \note{
        ...
        \begin{enumerate}
            ...
            \item Since the network attains $0$~loss and~$\bw_i(\infty) \in \cs_i$ for~all~$i$, then the following equation holds. Namely, the output of the network is determined only by the $i$-th~hidden~neuron $\bw_i(\infty)$, and it equals the target, $\by_i$.
